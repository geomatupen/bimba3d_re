...
powershell -NoProfile -ExecutionPolicy Bypass -File "%BOOTSTRAP_ROOT%\runtime-bootstrap.ps1" -InstallDir "%INSTALL_DIR%" -Phase "requirements"
>>"%WRAPPER_LOG%" echo [%date% %time%] EXIT code=%ERRORLEVEL% phase="requirements"
exit /b %ERRORLEVEL%
