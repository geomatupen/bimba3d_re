...
powershell -NoProfile -ExecutionPolicy Bypass -File "%BOOTSTRAP_ROOT%\runtime-bootstrap.ps1" -InstallDir "%INSTALL_DIR%" -Phase "torch"
>>"%WRAPPER_LOG%" echo [%date% %time%] EXIT code=%ERRORLEVEL% phase="torch"
exit /b %ERRORLEVEL%
